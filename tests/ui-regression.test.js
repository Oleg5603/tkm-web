...
assert.equal((html.match(/class="picker-story-card"/g) || []).length, 3, 'У подбора точек должно быть три демонстрационных отзыва');
assert.match(html, /не являются отзывами реальных клиентов/);
