...
assert.match(html, /assets\/gavrik\.js\?v=20260902-1/);
assert.match(html, /assets\/app\.js\?v=20260902-1/);
assert.match(html, /assets\/landing\.css\?v=20260902-1/);
...
assert.match(app, /window\.GavrikUtils\.respond\(question\)/);
